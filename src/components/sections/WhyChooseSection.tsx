...
export function WhyChooseSection() {
  return (
    <section className="bg-white px-6 pb-24 lg:px-10 lg:pb-32">
      <div className="relative mx-auto max-w-6xl">
        <div className="relative overflow-hidden rounded-[2rem] bg-navy px-6 py-14 shadow-[0_24px_60px_-16px_rgba(44,71,104,0.35)] sm:px-10 sm:py-16 lg:px-14 lg:py-20">
          ...
          <div className="relative mt-12 grid gap-5 md:grid-cols-3 lg:mt-14">
            {features.map(({ icon: Icon, title, description }) => (
              <article
                key={title}
                className="glass-panel-dark group rounded-2xl px-6 py-8 text-center transition duration-300 hover:-translate-y-1 hover:border-white/20 hover:bg-white/10 sm:px-7 sm:py-10"
              >
